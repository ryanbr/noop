...
fun rejectedHistoricalRecords(
    ...
    return rawFrames.filter { frame ->
        ...
        // the very next trim ack. That is exactly the shape a novel record (an on-demand MG ECG capture,
        // a new firmware's rollup) can take. Deciding on the VERSION makes it structural.
        //
