...
**🌡️ Vitals & raw signals.** HRV (RMSSD + SDNN from real R-R intervals), live HR with zones, a full skin-temperature suite feeding cycle / circadian / illness tracking, respiratory rate, and raw optical and motion records banked locally.
...
> Alarm boundary: a successfully stored firmware schedule can run independently of
> the app. Storage, driver and physical execution limits still apply; see
> [alarm execution](../PROTOCOL_ALARMS.md).
