...
- **Smaller display fixes.** skin-temp banding no longer misreads an absolute reading (#111); the steps empty-state reads correctly on WHOOP 5.0/MG (#107); Today hero labels no longer wrap (#78); and the Settings Appearance card has its row dividers back (#79).
