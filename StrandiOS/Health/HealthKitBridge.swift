...
final class HealthKitBridge: ObservableObject {
    ...
    private func readTypes(for stage: ConsentStage) -> Set<HKObjectType> {
        ...
        case .coreRead:
            ...
            // #1205: workout routes are separate samples associated with each HKWorkout. Keep them
            // in the core read stage so imported workouts retain their GPS maps after consent is split.
    ...
    private func migrateStrandedHealthRecords(fromTs: Int, nowTs: Int) async throws {
        ...
        for id in Self.nightlyVitalsWriteIds {
